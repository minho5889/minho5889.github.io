...
// display videos in the list thats what prof means 'all'
const videosList = [
  {
...
function showAllClicked() {
  for(let i = 0; i<videosList.length; i++) {
    let code = `${generateRowHTML(videosList[i])}`
...
function searchClicked() {
  ...
  document.querySelector("#results").innerHTML = "" // reset
...
// CLICK HANDLERS
document.querySelector("#btn-show-all").addEventListener("click", showAllClicked)
document.querySelector("#btn-search").addEventListener("click", searchClicked)